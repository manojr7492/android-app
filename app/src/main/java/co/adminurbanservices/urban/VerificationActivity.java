...
import static co.adminurbanservices.urban.Signup.EMAIL;
import static co.adminurbanservices.urban.Signup.MOBILE;
import static co.adminurbanservices.urban.Signup.NAME;
import static co.adminurbanservices.urban.Signup.PASSWORD;
        ...
        if (!skipPermissionCheck && ContextCompat.checkSelfPermission(this, Manifest.permission.READ_SMS) ==
            ...
            mVerification = SendOtpVerification.createSmsVerification
                    (SendOtpVerification
                            ...
                            .expiry("1")//value in minutes
                            .senderId("MTROSV") //where XXXX is any string
//                            .otp("1234")// Default Otp code if want to add yours
                            .otplength("4") //length of your otp
                            .message("<#> Your Metroservices OTP is ##OTP##. Note: Please DO NOT SHARE this OTP with anyone.")
                            .build(), this);
...
/*        Intent mainIntent = new Intent(Intent.ACTION_MAIN, null);
    ...
    private void registerUserverified() {
        ...
        final String username = aa.getStringExtra(NAME);
        final String email = aa.getStringExtra(EMAIL);
        final String mobile = aa.getStringExtra(MOBILE);
        final String password = aa.getStringExtra(PASSWORD);
